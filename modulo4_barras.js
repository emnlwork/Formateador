                ...
                headers.forEach(h => {
                    ...
                    if (h === 'CODIGO_FINAL' && val) {
                        ...
                        html += `<td style="white-space:nowrap;">
                            <button class="talla-btn" data-panel="${panelId}" data-idx="${idx}" data-tipo="normal" style="background:none; border:1px solid #555; border-radius:4px; cursor:pointer; padding:2px 6px; margin:0 2px;" title="Normal (calzado)">${iconNormal}</button>
                            <button class="talla-btn" data-panel="${panelId}" data-idx="${idx}" data-tipo="pantalon" style="background:none; border:1px solid #555; border-radius:4px; cursor:pointer; padding:2px 6px; margin:0 2px;" title="Pantalón">${iconPants}</button>
                            <button class="talla-btn" data-panel="${panelId}" data-idx="${idx}" data-tipo="cinto" style="background:none; border:1px solid #555; border-radius:4px; cursor:pointer; padding:2px 6px; margin:0 2px;" title="Cinto">${iconBelt}</button>
                        </td>`;
                    } else {
                        html += `<td>${val}</td>`;
                    }
